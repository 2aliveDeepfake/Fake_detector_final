...
def detect_fake(face_list, eye_list, nose_list, mouth_list,
    ...
    for i in range(len(f_list)):
        ...
        if (int(video.get(1)) % num == c ):
            ...
            # print(video_name)
            # print(vn)
            # print(len(label_face_str))
            # print(len(label_f_p_str))
            ...
            try :
                if (label_percent!="") :
                    ...
                    label_list += (str(vn) + "/"+ str(int(video.get(1))-1)+ "/"+str(label_face_str[int(video.get(1))-1])+str(label_f_p_str[int(video.get(1))-1])+str(label_percent) + "/0"+"/1\n")
                else :
                    ...
                    label_list += (str(vn) + "/"+ str(int(video.get(1))-1)+ "/"+str(label_face_str[int(video.get(1))-1])+str(label_f_p_str[int(video.get(1))-1])+str(label_percent) + "/1"+"/1\n")
            except :
    ...
    # print()
    txt = open('G:\\rnn_txt\\real_txt_01\\' + vn + '.txt', 'w', encoding='utf-8', newline='')
